...
const mockIssues = [
  { issue_id: '1', org_id: 'stellar-org', title: 'Fix onboarding flow', status: 'open', reward_xlm: 10, created_at: '2024-01-01' },
  { issue_id: '2', org_id: 'stellar-org', title: 'Add analytics dashboard', status: 'open', reward_xlm: 20, created_at: '2024-01-02' },
  { issue_id: '3', org_id: 'stellar-org', title: 'Improve docs', status: 'open', reward_xlm: 30, created_at: '2024-01-03' },
];
...
describe('OrgIssuesPage filters', () => {
  ...
  it('filters by search text, labels, and sort order', async () => {
    render(
      <ToastProvider>
